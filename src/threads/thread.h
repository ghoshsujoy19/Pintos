...
struct thread
  {
    ...
    int actual_priority;		            /* To restore actual priority after it is processed once after sleep */
    int priority_before_donation;       /* priority before donation */
    struct list_elem allelem;           /* List element for all threads list. */
    int64_t wakeup_time;
    int nice_value;                     /*integer*/
    int recent_cpu;                     /*fixed-point value*/
...
int effective_priority (struct thread*);
